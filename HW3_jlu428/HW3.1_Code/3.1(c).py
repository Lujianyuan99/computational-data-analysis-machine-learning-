...
# ax.set_ylabel("acc")
# plt.savefig("jointdistribution2D.jpg")
...
for i in range(len(xx1)):
    xx1[i] = get_kde(xAxis[i],x1,bandwidth1)

for j in range(len(xx2)):
    xx2[j] = get_kde(yAxis[j],x2,bandwidth2)
...
# ax.set_xlabel("amygdala")
# ax.set_ylabel("acc")
# plt.savefig("seprateTimesEachOther.jpg")
figure = plt.figure(figsize=(12, 10))
axes = figure.add_subplot(111)
# using the matshow() function
